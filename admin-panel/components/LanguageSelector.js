...
const translations = {
  fr: {
    ...
    vip_desc: '👑 BOUTIQUES VIP PREMIUM ✨\n\nDécouvrez notre sélection exclusive de boutiques certifiées avec services haut de gamme !',
    ...
    found: 'trouvée(s)',
    shops: 'boutiques',
    search_desc: '🔍 TROUVEZ VOTRE PLUG IDÉAL 🌍\n\nRecherchez parmi nos boutiques certifiées par nom, pays ou service. Livraison rapide et qualité garantie !',
    ...
    // Page détails boutique
    services_offered: 'Services proposés',
    delivery_countries: 'Pays de livraison',
    social_networks: 'Réseaux sociaux',
    no_social_networks: 'Aucun réseau social',
    contact_shop: 'Contacter la boutique',
  ...
  en: {
    ...
    no_social_networks: 'No social networks',
  ...
  es: {
    ...
    vip_desc: '👑 BOUTIQUES VIP PREMIUM ✨\n\n¡Descubre nuestra selección exclusiva de boutiques certificadas con servicios de alta gama!',
    ...
    delivery_countries: 'Países de entrega',
    social_networks: 'Redes sociales',
    no_social_networks: 'Sin redes sociales',
    contact_shop: 'Contactar tienda',
  ...
  it: {
    ...
    found: 'trovato/i',
    shops: 'negozi',
    search_desc: '🔍 TROVA IL TUO PLUG IDEALE 🌍\n\nCerca tra le nostre boutique certificate per nome, paese o servizio. Consegna veloce e qualità garantita!',
    ...
    delivery_countries: 'Paesi di consegna',
    social_networks: 'Social network',
    no_social_networks: 'Nessun social network',
    contact_shop: 'Contatta negozio',
    shop_details: 'Dettagli del negozio',
    countries: 'paesi',
    services: 'servizi',
    search_vip_only: 'Solo VIP',
  ...
  de: {
    ...
    vip_desc: '👑 VIP PREMIUM BOUTIQUEN ✨\n\nEntdecken Sie unsere exklusive Auswahl an zertifizierten Boutiquen mit High-End-Services!',
    ...
    back_to_shops: 'Zurück zu den Geschäften',
    loading_shop: 'Geschäft wird geladen',
    no_shops_found: 'Keine Geschäfte gefunden',
    error_loading: 'Fehler beim Laden',
    // Page détails boutique
    services_offered: 'Angebotene Dienste',
    delivery_countries: 'Lieferländer',
    social_networks: 'Soziale Netzwerke',
    no_social_networks: 'Keine sozialen Netzwerke',
